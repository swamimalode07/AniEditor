  ...
  return (
    <>
      ...
      <motion.section
        ...
        className="min-h-screen flex flex-col items-center justify-center relative bg-black px-6 md:px-12"
      >
          ...
          >
            <div className="w-[500px] h-[600px] flex items-center justify-center">
              <motion.img
                ...
                className="rounded-lg shadow-lg object-contain transform scale-x-[-1] transition-all duration-500 w-full h-full"
              />
            </div>
          </motion.div>
        </div>
